(custom-set-variables
 ...
 '(package-selected-packages
   '(nov-xwidget which-key vertico use-package rg restart-emacs projectile pdf-tools org-transclusion org-roam org-journal org-fragtog org-bullets orderless marginalia expand-region eglot company blacken benchmark-init beacon async ace-window)))
(custom-set-faces
